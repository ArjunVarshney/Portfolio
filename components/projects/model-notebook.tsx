...
const Notebook = ({ nb }: { nb: string }) => {
   ...
   const fetchNotebook = async () => {
      try {
         ...
         setNotebook("Something went wrong! Try viewing in github instead.");
         console.log(error);
      } finally {
         setLoading(false);
      }
   ...
   return loading ? (
      ...
      <div
         className={cn(
            Roboto.className,
            "bg-white text-black p-2 lg:p-8 pb-10 w-[calc(90vw-3rem)] rounded h-[calc(90vh-3rem)] overflow-auto"
         )}
